/*
* DAO classes map the model classes to the database tables using sql queries
*
* `JdbcTemplate jdbcTemplate: An instance of JdbcTemplate, which is provided by Spring and simplifies JDBC interactions by
* handling resource management and exception translation.
 */

package com.lg.spring.dao;

import com.lg.model.Person;
import com.lg.model.PersonMapper;
